...
public class ColorChange {
    ...
    public static final String DESTINATION_FILE = "./resources/many-flowers-changed.jpg";
    ...
    public static int getRed(int rgb) {
        //We mask the rbg to extract the Red Component, so by doing that we'd have something like: 00XX0000, but as we
        //want the XX value, we need to shift it 16 bits (2bytes) to the right (so we have the actual integer value
        return (rgb & 0x00FF0000) >> 16;
    }

    public static int getGreen(int rgb) {
        //We mask the rbg to extract the Green Component, so by doing that we'd have something like: 0000XX00, but as we
        //want the XX value, we need to shift it 8 bits (1byte) to the right (so we have the actual integer value
