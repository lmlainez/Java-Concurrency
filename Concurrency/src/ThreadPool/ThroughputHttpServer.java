...
public class ThroughputHttpServer {
    ...
    /**
     * We create a server in which we specify an executor with the number of threads.
     * the server wil utilize that pool in order to respond to all requests.
     * All requests have the url /search?word={wordToSearch}
     * @param book
     * @throws IOException
     */
