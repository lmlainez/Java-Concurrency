...
public class ProductReviewsService {
    ...
    ReentrantReadWriteLock reviewLock;
    ...
    public ProductReviewsService() {
        ...
        productLock = new ReentrantReadWriteLock();
        reviewLock = new ReentrantReadWriteLock();
    }
    ...
    Lock getLockForAddProductReview() {
        return reviewLock.writeLock();
    }

    Lock getLockForGetAllProductReviews() {
        return reviewLock.readLock();
    }
